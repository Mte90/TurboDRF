...
class Book(TurboDRFMixin, models.Model):
    ...
    def turbodrf(cls):
        return {
            'fields': {
                'list': ['id', 'title', 'author', 'author__name', 'price', 'published_date'],
                'detail': ['id', 'title', 'author', 'author__name', 'author__email', 'isbn', 'price', 'published_date', 'description', 'created_at']
            }
        }
...
class Review(TurboDRFMixin, models.Model):
    ...
    def turbodrf(cls):
        return {
            'fields': ['id', 'book', 'book__title', 'reviewer_name', 'rating', 'comment', 'created_at']
        }
